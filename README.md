...
User input: Game directory. Must be a **file**.
...
Output (with all steps finished): All text files, organized in the original file structure.\
Workflow:
...
2. Non-"wad.client" files -> Formatted text files.
    - The following encodings are supported:
        - ANSI
        - UTF-8
    - The following text formats are collected:
        - .json
        - .txt
        - .js
        - .xml
