    ...
    var e = [, e => {
            ...
            var i = s.Ember.Component.extend({
                ...
                willDestroyElement() {
                    ...
                    this.get("wheel") && e.removeEventListener("wheel", this.get("wheel")), this.get("keydown") && document.removeEventListener("keydown", this.get("keydown")), this.clearBackgroundImage()
                },
                ...
                updateTrackWithRewardsInReview(e) {
                    ...
                    if (t > 48) {
                        const e = this.getRewardTrack(!0).map((e => e.threshold)),
                            t = this.getLastOfArray(e).threshold + 1;
