(() => {
    var e = [, e => {
            ...
            e.exports = n.Ember.Component.extend({
                ...
                shouldShowQuantity: n.Ember.computed("isXPReward", "isCurrencyReward", "isEventCurrencyReward", "isLOL", "isJade", (function() {
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                const e = {
                    ...
                    MilestoneTooltipComponent: J,
                    MasterySetCarouselComponent: q,
            ...
            t.default = n.Ember.Controller.extend({
                ...
                isJade: n.Ember.computed.equal("gameType", i.OBJECTIVES_GAME_TABS.JADE_TAB),
