    ...
    var e = [function(e, t, n) {
            ...
            class T extends r.default {
                ...
                _applyConnectionStateText() {
                    ...
                    this.addClass(this._connectionState, e), this.addInnerHtml(i.tra.get(`parties_comm_panel_state_${this._connectionState}`), e);
                    const t = this.shadowRoot.querySelector(this._selectors.connectionCheckbox);
                    t && (t.checked = this._connectionState === f.VOICE_CONNECTED_STATE, t.disabled = this._connectionState === f.VOICE_CONNECTING_STATE)
                }
                _updateConnectionState(e) {
                    ...
                    if (t !== e) {
                        ...
                        const r = this._teamVoicePluginEnabled ? this._selectors.connectionStatus : this._selectors.connectionState;
                        this.removeClass(t, r), this.addClass(this._connectionState, r), this.addInnerHtml(i.tra.get(`parties_comm_panel_state_${this._connectionState}`), r)
                    }
                }
