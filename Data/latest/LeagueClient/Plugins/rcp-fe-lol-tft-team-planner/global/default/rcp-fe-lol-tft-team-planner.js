(() => {
    var e = [, e => {
            ...
            t.default = class {
                ...
                show(e) {
                    ...
                    (this._teamPlannerInstance ? Promise.resolve() : this._createTeamPlannerInstance().renderPromise).then((() => (n.LayerManager.addLayer(this._teamPlannerInstance.domNode), this.teamPlannerService.setStateFromPreviousContext()))).then((() => {
                        this._componentState.set("isVisible", !0), s.SFX.openFlyout.play(), this.teamplannerSessionId = D(), this.activatedFromSource = e, this.sessionStartTime_ms = Date.now(), this.subViewSessionStartTime_ms = Date.now()
                    }))
                }
                _compareTeams(e, t) {
                ...
                hide(e) {
                    ...
                    this._componentState.set("isVisible", !1), n.LayerManager.removeLayer(this._teamPlannerInstance.domNode), s.SFX.closeFlyout.play();
                    let t = 0,
                        a = 0,
                        l = 0;
            ...
            e.exports = n.HTMLBars.template({
                id: "3fkpdkfG",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\v3\\\\Releases_15_24\\\\LeagueClientContent_Release\\\\15682\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-tft-team-planner\\\\src\\\\app\\\\templates\\\\myTeams\\\\my-teams-root.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["append",["unknown",["my-teams-header"]],false],["text","\\n"],["append",["helper",["my-teams-list"],null,[["SetId"],["Set5"]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, a) => {
            "use strict";
