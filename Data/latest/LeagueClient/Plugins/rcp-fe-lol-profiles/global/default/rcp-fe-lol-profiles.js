(() => {
    var e = [, e => {
            ...
            var l = a.Ember.Component.extend(i.default, {
                ...
                openHonorDrawer() {
                    const e = a.UIKit && a.UIKit.getDrawerManager && a.UIKit.getDrawerManager();
                    if (!e || !a.SharedPlayerBehaviorApps || !a.SharedPlayerBehaviorApps.createHonorPanel) return !1;
                    const t = a.SharedPlayerBehaviorApps.createHonorPanel();
