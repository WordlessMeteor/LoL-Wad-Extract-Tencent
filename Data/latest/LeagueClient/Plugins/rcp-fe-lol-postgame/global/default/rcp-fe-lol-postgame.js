(() => {
    var e = [, e => {
            ...
            const o = [n.GAME_MODES.JADE, n.GAME_MODES.CRAB];
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                const e = {
                    ...
                    PostgameScoreboardBreakdownComponent: _.default,
                    ...
                    SeasonPassErrorStateComponent: _t.default,
                    ...
                    TEMPLATES: {
                        ...
                        "components/postgame-scoreboard-progression-ranked": _e.default,
                ...
                Object.assign(e.TEMPLATES, {
                    ...
                    "components/jade-ranked-progression": Ds,
                    "components/jade-scoreboard-header": Ns,
            ...
            var n = s(1),
                ...
                o = s(3),
                l = s(30);
            var i = n.Ember.Controller.extend({
                ...
                isEoGPhase: n.Ember.computed.equal("gameflow.phase", l.GAMEFLOW_PHASES.EndOfGame),
                ...
                isWaitingForStats: n.Ember.computed.equal("gameflow.phase", l.GAMEFLOW_PHASES.WaitingForStats),
                ...
                gameFlowPhaseObserver: n.Ember.observer("gameflow.phase", (function() {
                    ...
                    e !== t && (e === l.GAMEFLOW_PHASES.WaitingForStats ? (n.Telemetry.startTracingEvent("client-waiting-for-stats-to-honor-shown"), n.datadogRum.startOperation(n.datadogRum.XP_CGL_POSTGAME, {
                        ...this.get("datadogContext"),
                        start: {
                            source: `gameflow-phase-${e}`
                        }
                    })) : e === l.GAMEFLOW_PHASES.PreEndOfGame ? (n.datadogRum.startOperation(n.datadogRum.XP_CGL_POSTGAME_PRE_END_OF_GAME, {
                        ...this.get("datadogContext"),
                        start: {
                            source: `gameflow-phase-${e}`
                        }
                    }), n.TelemetryService.startTelemetryTimerEvent("eog_screen"), this.renderTime = Date.now()) : e === l.GAMEFLOW_PHASES.EndOfGame && (n.datadogRum.stopOperationWithOk(n.datadogRum.XP_CGL_POSTGAME_PRE_END_OF_GAME, {
                        stop: {
                            source: `gameflow-phase-${e}`
                        }
            ...
            e.exports = n.HTMLBars.template({
                id: "lX+gAvER",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\vfs\\\\mount-Releases\\\\16.19\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-postgame\\\\src\\\\app\\\\templates\\\\application.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["open-element","div",[]],["static-attr","class","postgame-application"],["flush-element"],["text","\\n  "],["append",["unknown",["outlet"]],false],["text","\\n"],["close-element"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, s) => {
            const n = s(1).Ember;
            ...
            e.exports = n.HTMLBars.template({
                id: "SHsIDmsW",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\vfs\\\\mount-Releases\\\\16.19\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-postgame\\\\src\\\\app\\\\templates\\\\components\\\\tft-tooltip.hbs\\" style-path=\\"null\\" js-path=\\"T:\\\\vfs\\\\mount-Releases\\\\16.19\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-postgame\\\\src\\\\app\\\\components\\\\tft-tooltip.js\\" "],["text","\\n"],["open-element","lol-uikit-tooltip",[]],["dynamic-attr","id",["concat",["tft-tooltip-",["unknown",["tooltipId"]]]]],["flush-element"],["text","\\n  "],["yield","default"],["text","\\n"],["close-element"]],"locals":[],"named":[],"yields":["default"],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, s) => {
            const n = s(1).Ember;
            ...
            const {
                RunMixin: i
            } = n.EmberAddons.EmberLifeline, r = "/lol-summoner/v1/current-summoner", m = "/lol-lobby/v2/party/eog-status", c = "PROGRESSION", d = "SCOREBOARD", p = n.Ember.Object.extend(n.Ember.PromiseProxyMixin);
            var u = n.Ember.Component.extend(i, {
                ...
                isProgressionTabSelected: n.Ember.computed.equal("selectedTab", c),
                isScoreboardTabSelected: n.Ember.computed.equal("selectedTab", d),
                ...
                forwardClickSound: "/fe/lol-postgame/sfx-nav-button-play-click.ogg",
                init() {
                    this._super(...arguments), this.binding = n.dataBinding.bindTo(n.socket), this.binding.observe(r, this, this._handleCurrentSummoner), this.binding.observe(m, this, this._handlePartyStatus), this.set("modalDoneShowing", !1), this.set("extEmberModel", n.extEmberModel), this.get("remedy"), n.TelemetryService.startTelemetryTimerEvent("eog_tabs")
                },
                didInsertElement() {
                    this._super(...arguments), this._startCountdown(), n.Telemetry.startTracingEvent(l.TELEMETRY_EVENT_NAMES.RENDER_PROGRESSION_SCREEN), n.Ember.run.scheduleOnce("afterRender", this, (() => {
                        n.Telemetry.endTracingEvent(l.TELEMETRY_EVENT_NAMES.RENDER_POST_GAME), n.Telemetry.startTracingEvent(l.TELEMETRY_EVENT_NAMES.TIME_ON_EOG)
                    }))
                },
                willDestroyElement() {
                    this._super(...arguments), this.cancelTask(this._proceedToScoreboardTimer), n.Telemetry.endTracingEvent(l.TELEMETRY_EVENT_NAMES.TIME_ON_EOG), this._observedUpdateChallengesPath && this.binding.unobserve(this._observedUpdateChallengesPath, this), this.binding.unobserve(r, this), this.binding.unobserve(m, this), n.TelemetryService.stopTelemetryTimerEvent("eog_tabs", "timeSpent", "postgame", {
                ...
                actions: {
                    ...
                    onButtonClick() {
                        ...
                        this.get("isProgressionTabSelected") ? (this.set("isContinueButtonClicked", !0), this._selectTab(d), this._stopCountdown()) : e.couldShowRemedyVerbalAbuseModal(this.get("gameId")) && !this.get("hasShownVerbalAbuseRemedyModal") ? this._showVerbalAbuseRemedyModal() : (n.datadogRum.startOperation(n.datadogRum.XP_CGL_POSTGAME_PLAY_AGAIN, {
                            game: {
                                key: a.GAME_CONTEXT_KEYS.LEAGUE_OF_LEGENDS
                            },
                            start: {
                    ...
                    displayAdvancedDetails: function() {
                        ...
                        o.JADE_POSTGAME_GAME_MODES.includes(this.get("gameMode")) && (t = ["stats", "graph"]), (0, n.getProvider)().getOptional("rcp-fe-lol-match-history").then((s => {
            ...
            e.exports = n.HTMLBars.template({
                id: "EE8ouYXi",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\vfs\\\\mount-Releases\\\\16.19\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-postgame\\\\src\\\\app\\\\templates\\\\components\\\\v2\\\\render-timer.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["block",["if"],[["get",["isTimeToShow"]]],null,0]],"locals":[],"named":[],"yields":["default"],"blocks":[{"statements":[["text","  "],["yield","default"],["text","\\n"]],"locals":[]}],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, s) => {
            const n = s(1).Ember;
