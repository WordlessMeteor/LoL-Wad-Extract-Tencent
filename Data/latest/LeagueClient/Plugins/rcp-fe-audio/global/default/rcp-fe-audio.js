    ...
    var t = [, t => {
            ...
            Object.assign(f.prototype, {
                ...
                _initializeMusicSubChannels: function(t) {
                    ...
                    const a = {
                            name: u.MUSIC_SUB_CHANNEL_CLIENT_AMBIENCE,
                            volume: 1,
                            maxConcurrent: 1,
                            playbackStrategy: "large_file"
                        },
                        c = this._createChannel(a, t);
                ...
                _initializeSfxSubChannels: function(t) {
                    ...
                    const p = {
                        ...
                        _ = this._createChannel(p, t);
                    this.channels.set(p.name, _)
                },
            ...
            Object.assign(h.prototype, {
                ...
                createSound: function(t, e = {}) {
                    ...
                    (this.get("crossfade") || e.crossfade) && (n.fadeIn = !0, n.fadeOut = !0);
                    const i = Object.assign(n, e),
                        r = this._createSoundObject(t, i);
                    return this._attachListeners(r), r
                },
                stopAll: function() {
                    this.playingSounds.forEach((t => t.dispose()))
                },
                ...
                _isAlreadyPlaying: function(t) {
                    const e = t.options.url;
                    return !!this.playingSounds.some((t => t.options.url === e))
                },
                ...
                _onSoundPlay: function(t) {
                    if (this._isAlreadyPlaying(t) || -1 !== this.playingSounds.indexOf(t)) return;
            ...
            Object.assign(u.prototype, {
                ...
                stop: function() {
                    return this._pause().then((() => this.trigger("stop", this)))
                },
                _pause: function() {
                ...
                fadeOut: function(t) {
                    ...
                    return this._fadeOutStopTimer = setTimeout((() => this.stop()), i), this.fade(e, n, i, o), r.default.delay(i, this).then((() => {
                        clearTimeout(this._fadeOutStopTimer), delete this._fadeOutStopTimer
                    }))
                },
            ...
            i = function() {
                ...
                return function t(e, n, i) {
                        ...
                        e.exports = function(e, n) {
                            ...
                            e.prototype.suppressUnhandledRejections = function() {
                                ...
                                if (this._isRejectionUnhandled()) {
                                    ...
                                    this._setUnhandledRejectionIsNotified(), U("unhandledRejection", r, t, this)
                                }
                            ...
                            e.config = function(t) {
                                ...
                                if ("cancellation" in t && t.cancellation && !Q.cancellation) {
                                    ...
                                    e.prototype._clearCancellationData = P, e.prototype._propagateFrom = j, e.prototype._onCancel = T, e.prototype._setOnCancel = F, e.prototype._attachCancellationCallback = w, e.prototype._execute = A, x = j, Q.cancellation = !0
                                }
                            ...
                            c.inherits(z, Error), n.CapturedTrace = z, z.prototype.uncycle = function() {
                                ...
                                if (!t.__stackCleaned__) {
                                    this.uncycle();
                                    for (var e = L(t), n = e.message, i = [e.stack], r = this; void 0 !== r;) i.push(R(r.stack.split("\n"))), r = r._parent;
                                    ! function(t) {
                            ...
                            var $ = function() {
                                var t = /^\s*at\s*/,
                                    e = function(t, e) {
                                        return "string" == typeof t ? t : void 0 !== e.name && void 0 !== e.message ? e.toString() : V(e)
                                    };
                                ...
                                var i, r = new Error;
                                if ("string" == typeof r.stack && r.stack.split("\n")[0].indexOf("stackDetection@") >= 0) return f = /@/, p = e, _ = !0,
                                    function(t) {
                                ...
                                return !("stack" in r) && i && "number" == typeof Error.stackTraceLimit ? (f = t, p = e, function(t) {
                                    ...
                                    return "string" == typeof t ? t : "object" != typeof e && "function" != typeof e || void 0 === e.name || void 0 === e.message ? V(e) : e.toString()
                                }, null)
                            }();
                    ...
                    12: [function(t, e, n) {
                        ...
                        for (var d = "join pop push shift unshift slice filter forEach some every map indexOf lastIndexOf reduce reduceRight sort reverse".split(" "), g = 0; g < d.length; ++g) "function" == typeof Array.prototype[d[g]] && (_.prototype[d[g]] = Array.prototype[d[g]]);
                    ...
                    22: [function(t, e, n) {
                        ...
                        e.exports = function() {
                            var e = function() {
                                ...
                                n = function() {
                                    return new w.PromiseInspection(this._target())
                                },
                                i = function(t) {
                                    return w.reject(new f(t))
                                };
                            ...
                            o = a.isNode ? function() {
                                ...
                                return null
                            }, a.notEnumerableProp(w, "_getDomain", o);
                            var u = t("./es5"),
                                c = t("./async"),
                                l = new c;
                            u.defineProperty(w, "_async", {
                                value: l
                            });
                            var h = t("./errors"),
                                f = w.TypeError = h.TypeError;
                            w.RangeError = h.RangeError;
                            var p = w.CancellationError = h.CancellationError;
                            w.TimeoutError = h.TimeoutError, w.OperationalError = h.OperationalError, w.RejectionError = h.OperationalError, w.AggregateError = h.AggregateError;
                            var _ = function() {},
                                d = {},
                                g = {},
                                y = t("./thenables")(w, _),
                            ...
                            function w(t) {
                                this._bitField = 0, this._fulfillmentHandler0 = void 0, this._rejectionHandler0 = void 0, this._promise0 = void 0, this._receiver0 = void 0, t !== _ && (function(t, e) {
                                    if ("function" != typeof e) throw new f("expecting a function but got " + a.classString(e));
                                    if (t.constructor !== w) throw new f("the promise constructor cannot be invoked directly\n\n    See http://goo.gl/MqrFmX\n")
                            ...
                            return w.prototype.toString = function() {
                            ...
                            }, w.prototype.caught = w.prototype.catch = function(t) {
                            ...
                            }, w.prototype.reflect = function() {
                                return this._then(n, n, void 0, this, void 0)
                            }, w.prototype.then = function(t, e) {
                            ...
                            }, w.prototype.done = function(t, e) {
                                this._then(t, e, void 0, void 0, void 0)._setIsFinal()
                            }, w.prototype.spread = function(t) {
                                return "function" != typeof t ? i("expecting a function but got " + a.classString(t)) : this.all()._then(t, void 0, void 0, d, void 0)
                            ...
                            }, w.fromNode = w.fromCallback = function(t) {
                                var e = new w(_);
                                ...
                                var h = o();
                                if (0 != (50397184 & c)) {
                                    var f, d, g = u._settlePromiseCtx;
                                    0 != (33554432 & c) ? (d = u._rejectionHandler0, f = t) : 0 != (16777216 & c) ? (d = u._fulfillmentHandler0, f = e, u._unsetRejectionIsUnhandled()) : (g = u._settlePromiseLateCancellationObserver, d = new p("late cancellation observer"), u._attachExtraTrace(d), f = e), l.invoke(g, u, {
                                ...
                                return a
                            }, w.prototype._length = function() {
                                return 65535 & this._bitField
                            }, w.prototype._isFateSealed = function() {
                                return 0 != (117506048 & this._bitField)
                            }, w.prototype._isFollowing = function() {
                                return 67108864 == (67108864 & this._bitField)
                            }, w.prototype._setLength = function(t) {
                                this._bitField = -65536 & this._bitField | 65535 & t
                            }, w.prototype._setFulfilled = function() {
                                this._bitField = 33554432 | this._bitField, this._fireEvent("promiseFulfilled", this)
                            }, w.prototype._setRejected = function() {
                                this._bitField = 16777216 | this._bitField, this._fireEvent("promiseRejected", this)
                            }, w.prototype._setFollowing = function() {
                                this._bitField = 67108864 | this._bitField, this._fireEvent("promiseResolved", this)
                            }, w.prototype._setIsFinal = function() {
                                this._bitField = 4194304 | this._bitField
                            }, w.prototype._isFinal = function() {
                                return (4194304 & this._bitField) > 0
                            }, w.prototype._unsetCancelled = function() {
                                this._bitField = -65537 & this._bitField
                            }, w.prototype._setCancelled = function() {
                                this._bitField = 65536 | this._bitField, this._fireEvent("promiseCancelled", this)
                            }, w.prototype._setAsyncGuaranteed = function() {
                                this._bitField = 134217728 | this._bitField
                            }, w.prototype._receiverAt = function(t) {
                                var e = 0 === t ? this._receiver0 : this[4 * t - 4 + 3];
                                if (e !== s) return void 0 === e && this._isBound() ? this._boundValue() : e
                            }, w.prototype._promiseAt = function(t) {
                                return this[4 * t - 4 + 2]
                            }, w.prototype._fulfillmentHandlerAt = function(t) {
                                return this[4 * t - 4 + 0]
                            }, w.prototype._rejectionHandlerAt = function(t) {
                                return this[4 * t - 4 + 1]
                            }, w.prototype._boundValue = function() {}, w.prototype._migrateCallback0 = function(t) {
                                t._bitField;
                            ...
                            }, w.prototype._migrateCallbackAt = function(t, e) {
                                var n = t._fulfillmentHandlerAt(e),
                                    i = t._rejectionHandlerAt(e),
                                    r = t._promiseAt(e),
                                    o = t._receiverAt(e);
                                void 0 === o && (o = s), this._addCallbacks(n, i, r, o, null)
                            }, w.prototype._addCallbacks = function(t, e, n, i, r) {
                                var o = this._length();
                            ...
                            }, w.prototype._proxy = function(t, e) {
                            ...
                            }, w.prototype._rejectCallback = function(t, e, n) {
                            ...
                            }, w.prototype._resolveFromExecutor = function(t) {
                                var e = this;
                            ...
                            }, w.prototype._settlePromiseFromHandler = function(t, e, n, i) {
                                var r = i._bitField;
                                if (0 == (65536 & r)) {
                                    var o;
                                    i._pushContext(), e === d ? n && "number" == typeof n.length ? o = A(t).apply(this._boundValue(), n) : (o = k).e = new f("cannot .spread() a non-array: " + a.classString(n)) : o = A(t).call(e, n);
                                    var s = i._popContext();
                            ...
                            }, w.prototype._target = function() {
                                for (var t = this; t._isFollowing();) t = t._followee();
                                return t
                            }, w.prototype._followee = function() {
                                return this._rejectionHandler0
                            }, w.prototype._setFollowee = function(t) {
                                this._rejectionHandler0 = t
                            }, w.prototype._settlePromise = function(t, e, i, o) {
                                ...
                                var e = t.handler,
                                    ...
                                    i = t.receiver,
                                    r = t.value;
                                "function" == typeof e ? n instanceof w ? this._settlePromiseFromHandler(e, i, r, n) : e.call(i, r, n) : n instanceof w && n._reject(r)
                            }, w.prototype._settlePromiseCtx = function(t) {
                                this._settlePromise(t.promise, t.handler, t.receiver, t.value)
                            }, w.prototype._settlePromise0 = function(t, e, n) {
                                var i = this._promise0,
                                    r = this._receiverAt(0);
                                this._promise0 = void 0, this._receiver0 = void 0, this._settlePromise(i, t, r, e)
                            }, w.prototype._clearCallbackDataAtIndex = function(t) {
                                var e = 4 * t - 4;
                                this[e + 2] = this[e + 3] = this[e + 0] = this[e + 1] = void 0
                            }, w.prototype._fulfill = function(t) {
                            ...
                            }, w.prototype._reject = function(t) {
                            ...
                            }, w.prototype._fulfillPromises = function(t, e) {
                                for (var n = 1; n < t; n++) {
                            ...
                            }, w.prototype._rejectPromises = function(t, e) {
                                for (var n = 1; n < t; n++) {
                            ...
                            }, w.prototype._settlePromises = function() {
                            ...
                            }, w.prototype._settledValue = function() {
                                var t = this._bitField;
                                return 0 != (33554432 & t) ? this._rejectionHandler0 : 0 != (16777216 & t) ? this._fulfillmentHandler0 : void 0
                            }, w.defer = w.pending = function() {
                                ...
                                c: 3
                            }), P(1), P((function() {})), P(void 0), P(!1), P(new w(_)), b.setBounds(c.firstLineError, a.lastLineError), w
                        }
                    }, {
                        "./any.js": 1,
                        "./async": 2,
                        ...
                        e.exports = function(e, n) {
                            ...
                            function g(t, e, n, i) {
                                for (var o = r.inheritedDataKeys(t), s = [], a = 0; a < o.length; ++a) {
                                    var u = o[a],
                                        l = t[u],
                                        h = i === f || f(u, l, t);
                                    "function" != typeof l || _(l) || d(t, u, e) || !i(u, l, t, h) || s.push(u, l)
                                }
                            ...
                            var y = u ? void 0 : function(t, u, c, l, h, f) {
                                ...
                                function d() {
                                    ...
                                    var l = "string" == typeof _ && this !== p ? this[_] : t,
                                        h = o(c, f);
                                    try {
                    ...
                    27: [function(t, e, n) {
                        ...
                        e.exports = function(e, n, i, r) {
                            ...
                            function s(t, a) {
                                ...
                                for (var h = l._fulfill, f = l._reject, p = 0, _ = t.length; p < _; ++p) {
                                    var d = t[p];
                                    (void 0 !== d || p in t) && e.cast(d)._then(h, f, void 0, l, null)
                                }
                                return l
                            }
                            e.race = function(t) {
                    ...
                    36: [function(t, e, i) {
                        ...
                        function P(t) {
                            return w(t) && r.propertyIsWritable(t, "stack")
                        }
                        ...
                        var B = "undefined" != typeof process && "[object process]" === x(process).toLowerCase();

                        function R(t, e) {
                            return B ? "production" [t] : e
                        }
                        var L = {
                                isClass: b,
                                isIdentifier: N,
            ...
            Object.assign(u.prototype, {
                ...
                play: function(t) {
                    return this._playPromise ? this._playPromise = this._playPromise.then((() => this._playAsync(t))) : this._playPromise = this._playAsync(t), this._playPromise
                },
                _playAsync: async function(t) {
                    try {
                        const {
                            when: e = 0,
                            offset: n = !1
                ...
                pause: function() {
                    return this._pause(!1), r.default.resolve()
                },
                _pause: function(t = !1) {
                    this.audioElement && (this.audioElement.pause(), t && (this.audioElement.currentTime = 0, this._startedPlaying = !1, this.trigger("stop", this)))
                },
                stop: function() {
                    return this._pause(!0), r.default.resolve()
                },
                fadeIn: function(t, e = !1) {
                    ...
                    return this.fade(n, i, o, s), this.isFadingOut() && (clearTimeout(this._fadeOutStopTimer), delete this._fadeOutStopTimer), e || setTimeout((() => {
                        this.isPlaying() || this.play()
                    }), 0), r.default.delay(o, this)
                },
                fadeOut: function(t) {
                    if (!this.isPlaying()) return this._playPromise && (this._shouldStop = !0), r.default.resolve(this);
                    const {
                        fadeFrom: e,
                        fadeTo: n,
                        fadeTime: i,
            ...
            Object.assign(s.prototype, {
                ...
                _changeSettings: function(t) {
                    ...
                    this._changeMasterGainNodeSettings(e), this._changeSFXSettings(e), this._changeMusicSettings(e), this._changeClientAmbienceMusicSettings(e), this._changeVoiceSettings(e)
                },
                ...
                _changeClientAmbienceMusicSettings(t) {
                    !1 === t.clientAmbienceMusicEnabled ? this._muteChannel(r.MUSIC_SUB_CHANNEL_CLIENT_AMBIENCE) : this._unmuteChannel(r.MUSIC_SUB_CHANNEL_CLIENT_AMBIENCE)
                },
            ...
            e.MUSIC_SUB_CHANNEL_CLIENT_AMBIENCE = "music-client-ambience";
...
//# sourceMappingURL=rcp-fe-audio.js.map