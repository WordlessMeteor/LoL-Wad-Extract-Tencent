(() => {
    var e = [function(e, t, n) {
            ...
            r.addEventListener(m, (function(e) {
                e.registrationHandler((async function(e) {
                    ...
                    const l = await s.default.ComponentFactory.create(t.getName()).emberAppInstancePromise,
                        ...
                        r = new a.SettingsApiImpl(s.default.logger, o);
                    s.default.api = r;
            ...
            var S = s.Ember.Controller.extend(a.default, {
                ...
                profilePrivacyEnabled: s.Ember.computed.equal("persistenceService.profilePrivacy.enabledState", c.ENABLED),
                isProfilePrivate: s.Ember.computed.equal("persistenceService.profilePrivacy.setting", r.PRIVATE),
            ...
            var T = s.Ember.Controller.extend(a.default, {
                ...
                masterVolumeLabel: s.Ember.computed(c.property, (function() {
                ...
                persistenceService: s.Ember.inject.service("persistence"),
                init() {
                    this._super(...arguments), this.bindSetting(i), this.bindSetting(c), this.bindSetting(r), this.bindSetting(m), this.bindSetting(u), this.bindSetting(d), this.bindSetting(p), this.bindSetting(g), this.bindSetting(_), this.bindSetting(h), this.bindSetting(E), this.bindSetting(S), this.bindSetting(f);
            ...
            var x = s.Ember.Controller.extend(a.default, {
                ...
                init() {
                    this._super(...arguments), this.bindSetting(m), this.bindSetting(u), this.bindSetting(d), this.bindSetting(p), this.bindSetting(g), this.bindSetting(_), this.bindSetting(h), this.bindSetting(N), this.bindSetting(A), this.bindSetting(L), this.bindSetting(k), r.observe(o, this, (e => {
            ...
            var p = l.Ember.Component.extend({
                ...
                _resetCheckbox(e, t) {
                    ...
                    let r;
                    void 0 !== this.get(c) && null !== this.get(c) ? r = this._getDisplayValue(this.get(c), s) : void 0 !== o && (r = o), this._appendSaveData(t, e, r), !0 === a && (r = !r), this.set(i, r);
                ...
                _registerComputedProperty(e) {
                    ...
                    this.set(t, l.Ember.computed(c, r, (() => {
                        let e;
                        return void 0 !== this.get(c) && null !== this.get(c) ? e = this._getDisplayValue(this.get(c), s) : void 0 !== this.get(r) && null !== this.get(r) && (e = this._getDisplayValue(this.get(r), s)), s === i && !0 === a && (e = !e), this.set(o, e), l.logger.trace(`set ${t} value to ${e}`), e
                    })))
                },
                ...
                _checkMasterVolumeStatus() {
                    ...
                    })), (s && !n.checked || !s && n.checked) && (n.checked = !n.checked, this.set(t, n.checked), this._saveProperty(r.checkbox, n.checked), l.logger.trace(`Update overall volume to ${n.checked}, because should disable is ${s}`))
                },
                _saveProperty(e, t) {
            ...
            var a = l.Ember.Mixin.create({
                ...
                _createDialogContentDiv: function(e, t, n, l) {
                    ...
                    const m = [];
                    m[0] = this.get(`inputSettings.${e}.${t}`), null === m[0] && (m[0] = "[<Unbound>]"), 0 !== n && (m[1] = n), r.textContent = (0, s.formatAdditionalKeyBindings)(m);
                ...
                showKeybindingDialog: function(e, t, n) {
                    ...
                    const o = this._createDialogContentDiv(e, t, n, a),
                        ...
                        m = e => {
                            ...
                            this.set("tempSavedValue", n), i.textContent = (0, s.formatAdditionalKeyBindings)([n]), i.setAttribute("empty", !1), c.disabled = !1, r.enableAcceptButton()
                        };
                    r.disableAcceptButton(), r.acceptPromise.then((() => {
                        ...
                        void 0 !== t && (e.preventDefault(), this.set("tempSavedValue", t), i.setAttribute("empty", !1), i.textContent = (0, s.formatAdditionalKeyBindings)([t]), c.disabled = !1, r.enableAcceptButton())
            ...
            var c = s.Ember.Component.extend(a.default, {
                persistenceService: s.Ember.inject.service("persistence"),
                init() {
                    ...
                    t = n => {
                        n && (i.unobserve("/lol-platform-config/v1/initial-configuration-complete", t), function(e) {
                            i.observe("/lol-settings/v2/config", (t => {
                                t ? (c(e, s.SettingsCategory.GAME_HOTKEYS, t.isHotkeysEnabled), c(e, s.SettingsCategory.GAME_SOUND, t.isSoundEnabled), c(e, s.SettingsCategory.GAME_INTERFACE, t.isInterfaceEnabled), c(e, s.SettingsCategory.GAME_GAMEPLAY, t.isGameplayEnabled), c(e, s.SettingsCategory.REPLAYS, t.isReplaysEnabled), c(e, s.SettingsCategory.TERMS_OF_USE, t.isTermsEnabled), c(e, s.SettingsCategory.PRIVACY_NOTICE, t.isPrivacyNoticeEnabled), c(e, s.SettingsCategory.LEGAL_STATEMENTS, t.isLegalStatementsEnabled)) : a.logger.warning("Failed to receive settings config")
                            }))
                        }(e))
                    };
            ...
            var T = l.Ember.Service.extend({
                ...
                willDestroy() {
                    this._super(...arguments), S.unobserve(a, this), S.unobserve(o, this), S.unobserve(i, this), S.unobserve(c, this), S.unobserve(u, this), S.unobserve(_, this), S.unobserve(h, this), S.unobserve(E, this), S.unobserve(d, this), S.unobserve(p, this), S.unobserve(g, this)
                }
            });
            t.default = T
        }, (e, t, n) => {
            ...
            e.exports = l.HTMLBars.template({
                id: "r5YzFEKK",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\vfs\\\\mount-Releases\\\\16.19\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-settings\\\\src\\\\app\\\\templates\\\\index.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            const l = n(1).Ember;
            ...
            e.exports = l.HTMLBars.template({
                id: "T9jwEksd",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\vfs\\\\mount-Releases\\\\16.19\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-settings\\\\src\\\\app\\\\templates\\\\game-sound.hbs\\" style-path=\\"T:\\\\vfs\\\\mount-Releases\\\\16.19\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-settings\\\\src\\\\app\\\\styles\\\\game-sound.styl\\" js-path=\\"null\\" "],["text","\\n"],["open-element","lol-uikit-scrollable",[]],["static-attr","overflow-masks","enabled"],["flush-element"],["text","\\n\\n  "],["append",["helper",["game-sound-content"],null,[["gameSettings","gameSettingsSchema","handleComponentInitialized"],[["get",["gameSettings"]],["get",["gameSettingsSchema"]],["helper",["action"],[["get",[null]],"handleComponentInitialized"],null]]]],false],["text","\\n\\n"],["close-element"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            const l = n(1).Ember;
            e.exports = l.HTMLBars.template({
                id: "BAH7AwHL",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\vfs\\\\mount-Releases\\\\16.19\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-settings\\\\src\\\\app\\\\templates\\\\game-interface.hbs\\" style-path=\\"T:\\\\vfs\\\\mount-Releases\\\\16.19\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-settings\\\\src\\\\app\\\\styles\\\\game-interface.styl\\" js-path=\\"null\\" "],["text","\\n"],["open-element","lol-uikit-scrollable",[]],["static-attr","overflow-masks","enabled"],["flush-element"],["text","\\n\\n  "],["append",["helper",["game-interface-content"],null,[["gameSettings","gameSettingsSchema","handleComponentInitialized"],[["get",["gameSettings"]],["get",["gameSettingsSchema"]],["helper",["action"],[["get",[null]],"handleComponentInitialized"],null]]]],false],["text","\\n\\n"],["close-element"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            const l = n(1).Ember;
            e.exports = l.HTMLBars.template({
                id: "iZHpBBg+",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\vfs\\\\mount-Releases\\\\16.19\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-settings\\\\src\\\\app\\\\templates\\\\game-gameplay.hbs\\" style-path=\\"T:\\\\vfs\\\\mount-Releases\\\\16.19\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-settings\\\\src\\\\app\\\\styles\\\\game-gameplay.styl\\" js-path=\\"null\\" "],["text","\\n"],["open-element","lol-uikit-scrollable",[]],["static-attr","overflow-masks","enabled"],["flush-element"],["text","\\n\\n  "],["append",["helper",["game-gameplay-content"],null,[["gameSettings","gameSettingsSchema","handleComponentInitialized"],[["get",["gameSettings"]],["get",["gameSettingsSchema"]],["helper",["action"],[["get",[null]],"handleComponentInitialized"],null]]]],false],["text","\\n\\n"],["close-element"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            const l = n(1).Ember;
            ...
            e.exports = l.HTMLBars.template({
                id: "lGaehycE",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\vfs\\\\mount-Releases\\\\16.19\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-settings\\\\src\\\\app\\\\templates\\\\loading.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["open-element","div",[]],["static-attr","style","display: flex; align-items: center; height: 100%;"],["flush-element"],["text","\\n  "],["append",["helper",["uikit-spinner"],null,[["style"],["margin-left: auto; margin-right: auto;"]]],false],["text","\\n"],["close-element"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            const l = n(1).Ember;
            ...
            e.exports = l.HTMLBars.template({
                id: "j5+6C01A",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\vfs\\\\mount-Releases\\\\16.19\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-settings\\\\src\\\\app\\\\templates\\\\components\\\\settings-slider.hbs\\" style-path=\\"null\\" js-path=\\"T:\\\\vfs\\\\mount-Releases\\\\16.19\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-settings\\\\src\\\\app\\\\components\\\\settings-slider.js\\" "],["text","\\n"],["open-element","lol-uikit-slider",[]],["static-attr","class","lol-settings-slider"],["dynamic-attr","value",["unknown",["value"]],null],["dynamic-attr","percentage",["unknown",["percentage"]],null],["dynamic-attr","disabled",["unknown",["disabled"]],null],["dynamic-attr","clickset",["unknown",["clickset"]],null],["flush-element"],["text","\\n"],["close-element"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            const l = n(1).Ember;
