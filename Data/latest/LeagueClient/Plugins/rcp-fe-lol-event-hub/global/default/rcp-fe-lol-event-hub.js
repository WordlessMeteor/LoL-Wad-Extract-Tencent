(() => {
    var e = [, e => {
                ...
                l = a.Ember.Service.extend({
                    ...
                    checkPassFullyUpgraded(e = void 0) {
                        return this.set("passFullyUpgraded", !1), this.getPassBundles().then((t => {
                            ...
                            return this.set("passFullyUpgraded", s), this.set("bundles", t), t
                        })).catch((e => {
            ...
            var i = s.Ember.Controller.extend(r, {
                ...
                shouldDisplayPurchasePassButton: s.Ember.computed("eventHubService.bundles", (function() {
