    ...
    var e = [, e => {
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                const e = {
                        ...
                        SeasonPassChapterCardComponent: z.default,
            ...
            var s = n(5),
                ...
                l = a.Ember.Service.extend({
                    ...
                    observeEventSpecificData() {
                        const e = s.EVENT_CONFIGS_BY_TYPE[this.activeEventType]?.observers || [];
                        for (const {
                                propertyName: t,
                                propertyPath: n,
                                defaultValue: s
                            ...
                            this.eventSpecificObservers.push({
                                ...
                                this.isDestroying || this.isDestroyed || (null == e && (e = s), this.setProperties({
                                    [t]: e
                                }))
                            }))
                        }
                    ...
                    checkPassFullyUpgraded(e = void 0) {
                        return this.set("passFullyUpgraded", !1), this.getPassBundles().then((t => {
                            ...
                            return this.set("passFullyUpgraded", s), t
                        })).catch((e => {
                            a.logger.error("Failure loading pass bundles: ", e), this.set("bundles", null)
                        }))
                    },
                    async getPassBundles() {
                        return await this.eventHubDataBinding.get(this.getEventSpecificPropertyPath(s.PASS_BUNDLES_PATH), {
                            skipCache: !0
                        })
                    },
            ...
            var r = s.Ember.Component.extend(l, {
                ...
                observeShowPurchaseModal() {
                    this.get("showPurchaseModal") && (this.fetchProgressionPurchaseData(), s.Telemetry.sendCustomData(a.TELEMETRY.TABLE, {
            ...
            var l = s.Ember.Component.extend({
                ...
                traPrefix: s.Ember.computed("eventHubService.activeEventType", (function() {
                    return a.EVENT_CONFIGS_BY_TYPE[this.get("eventHubService.activeEventType")]?.traPrefix
                })),
            ...
            t.TOTAL_REWARDS = r;
            const i = 1055;
            t.SCROLLING_DISTANCE_SPARSE = i;
            var c = s.Ember.Component.extend({
                clickedRewardPrevious: null,
                init() {
                    this._super(...arguments), this.addObserver("selectedReward", this.updateBackgroundWithRelevantImage)
                },
                didInsertElement() {
                    this._super(...arguments), this.updateBackgroundWithRelevantImage(), this.showHextechRings(), s.Ember.run.scheduleOnce("afterRender", this, (() => {
                        const e = e => {
                                const t = e.deltaY > 0 ? "right" : "left";
                                this.scrollToNextPage(t, 1500)
                            },
                            t = e => {
                                const t = {
                                    ArrowRight: "right",
                                ...
                                this.scrollToNextPage(t, 750)
                            };
                        this.element.querySelector(".reward-tracker-scrollable").addEventListener("wheel", e, {
                            passive: !1
                        }), document.addEventListener("keydown", t), this.set("wheel", e), this.set("keydown", t)
                    }))
                },
                willDestroyElement() {
                    this._super(...arguments), this.removeObserver("selectedReward");
                    const e = this.element?.querySelector(".reward-tracker-scrollable");
                    this.get("wheel") && e.removeEventListener("wheel", this.get("wheel")), this.get("keydown") && document.removeEventListener("keydown", this.get("keydown"))
                },
                scrollToNextPage(e, t) {
                    if (this.element?.querySelector) {
                        const n = this.element.querySelector(".reward-tracker-scrollable");
                        if (this.get("scrollInProgress") || !n || "left" !== e && "right" !== e) return;
                        const s = "right" === e ? i : -1055;
                        this.set("scrollInProgress", !0), n.scrollTo({
                            left: n.scrollLeft + s,
                            behavior: "smooth"
                        }), setTimeout((() => this.set("scrollInProgress", !1)), t)
                    }
                },
                updateBackgroundWithRelevantImage() {
                    const e = this.get("selectedChapter"),
                        t = this.get("selectedReward"),
                        n = parseInt(t?.item?.threshold) > r,
                ...
                selectedReward: s.Ember.computed("currentLevel", "rewardTrackItems", "rewardTrackBonusItems", "clickedReward", (function() {
                    const e = this.get("currentLevel");
                    if (void 0 === e) return;
                    const t = this.get("clickedReward");
                    if (t) return this.set("clickedRewardPrevious", t), this.set("clickedReward", null), t;
                    let n = 8 * Math.ceil(e / 8);
                    0 === n && (n = 8);
                    let s = this.get("rewardTrackItems")[n - 1];
                    const l = s?.rewardOptions?.[0]?.state === a.REWARD_TRACKER.REWARD_STATE.SELECTED;
                    if (!s || l && n === r) s = this.get("rewardTrackBonusItems")?.[7];
                    else if (l) {
                        const t = 8 * Math.ceil(e + 1 / 8);
                        s = this.get("rewardTrackItems")[t - 1]
                    }
                    return {
                        item: s,
                        optionIndex: 0
                ...
                autoSelectChaseReward(e) {
                    this.set("currentClickedReward", this.get("clickedReward"));
                    const t = Math.max(...e),
                        n = this.get("rewardTrackItems");
                    if (t < r && (t + 1) % 8 == 0) {
                        const e = n[t];
                        ...
                        const e = this.get("rewardTrackBonusItems");
                ...
                handleRewardsInView(e, t) {
                    if (!Array.isArray(e) || 0 === e?.length) return;
                    if (!t) return void this.autoSelectChaseReward(e);
                    const n = parseInt(t?.item?.threshold);
                    if (isNaN(n)) return;
                    if (n % 8 == 0) return void this.autoSelectChaseReward(e);
                    const s = n > r,
                        a = e.includes(49);
                    s && a ? this.handleBonusTrack(e, n) : this.handleMainTrack(e, n)
                },
                handleMainTrack(e, t) {
                    return e.includes(t) ? this.setClickedReward(t) : this.autoSelectChaseReward(e)
                },
                handleBonusTrack(e, t) {
                    const n = this.get("rewardTrackBonusItems");
                    if (!Array.isArray(n)) return;
                    const s = n?.find((e => parseInt(e.threshold) === t));
                    return s ? this.setClickedReward(t) : this.autoSelectChaseReward(e)
                },
                setClickedReward(e) {
                    const t = this.get("rewardTrackItems"),
                        n = this.get("rewardTrackBonusItems");
                    if (!Array.isArray(t) || !Array.isArray(n)) return;
                    const s = n?.map((e => parseInt(e.threshold))) || [0];
                    if (e > Math.max(...s)) return;
                    const a = e > r,
                        l = a ? e % r - 1 : e - 1,
                        o = a ? n : t,
                        i = o?.[l];
                    i && this.set("clickedReward", {
                        item: i,
                        optionIndex: 0
                    })
                },
                actions: {
                    rewardsInViewChanged(e = []) {
                        this.handleRewardsInView(e, this.get("clickedRewardPrevious"))
                    },
                    rewardItemClick(e, t) {
                        s.Telemetry.sendCustomData(l.TELEMETRY.TABLE, {
            ...
            var i = s.Ember.Controller.extend(r, {
                ...
                playerSettingsService: s.Ember.inject.service("player-settings"),
                eventHubService: s.Ember.inject.service("event-hub"),
                isFullClientBackground: s.Ember.computed("eventHubService.eventDetailsData.actBackgroundImage", (function() {
                    return !!this.get("eventHubService.eventDetailsData.actBackgroundImage")
                })),
                ...
                isActBackground: s.Ember.computed("backgroundImagePath", "eventHubService.eventDetailsData.actBackgroundImage", (function() {
                    return this.get("backgroundImagePath") === this.get("eventHubService.eventDetailsData.actBackgroundImage")
                })),
                ...
                mandatoryDataLoaded: s.Ember.computed("chapters", "currentLevel", "chapterInView", (function() {
                ...
                levelFocus: s.Ember.computed("currentLevel", "navRouterSource", "totalNumberOfLevels", "rewardTrackItems", (function() {
                    const e = this.get("currentLevel"),
                        t = this.get("rewardTrackItems")?.find((t => {
                            try {
                                return parseInt(t.threshold) === e
                            } catch (e) {
                                return void s.logger.error("Could not parse reward treshold", e)
                            }
                        })),
                        n = t?.rewardOptions?.[0]?.state === o.REWARD_TRACKER.REWARD_STATE.SELECTED,
                        r = e % l.REWARDS_PER_PAGE == 0 && n,
                        i = this.get("navRouterSource") === a.ACTIVITY_CENTER_APP ? this.get("totalNumberOfLevels") : r ? e + 1 : e;
                    return this.set("navRouterSource", null), i
                })),
            ...
            var r = s.Ember.Controller.extend(l, {
                playerSettingsService: s.Ember.inject.service("player-settings"),
                eventHubService: s.Ember.inject.service("event-hub"),
