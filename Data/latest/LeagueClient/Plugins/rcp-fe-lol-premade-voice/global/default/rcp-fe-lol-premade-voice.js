(() => {
    var e = [function(e, t, n) {
            ...
            class D extends r.default {
                ...
                constructor() {
                    super(), this._participants = [], this._participantMap = new Map, this._teamParticipants = [], this._teamParticipantMap = new Map, this._partyMemberPuuids = new Set, this._multiUserChatId = null, this._gameflowPhase = "", this._isGameClientRunning = !1, this._lastVolumeUpdate = 0, this._lockOutMemberJoinSound = !1, this._isDraggingMicSlider = !1, this._clashRoster = null, this._headerType = C.HEADER_LOBBY, this._connectionState = f.VOICE_DISCONNECTED_STATE, this._teamConnectionState = f.VOICE_DISCONNECTED_STATE, this._updatingTeamToggle = !1, this._teamVoicePluginEnabled = !1, this._teamVoiceAvailability = !1, this._teamVoiceAvailabilityReason = null, this._puuidsToNameOverrides = {};
                ...
                _refreshConnectionState() {
                    ...
                    e ? this._updateConnectionState(f.VOICE_CONNECTED_STATE) : this._connectionState !== f.VOICE_CONNECTING_STATE && this._updateConnectionState(f.VOICE_DISCONNECTED_STATE), t !== this._connectionState && (this._updateTeamHeaderVisibility(), this._updateConnectionBarVisibility()), this._checkAvailabilityMessaging()
                }
                settingsUpdated(e) {
            ...
            class k extends i.default {
                ...
                _handleKeyDown(e) {
                    this._teamVoicePluginEnabled && (this._pttTeamKey && this._teamConnectionState === y.VOICE_CONNECTED_STATE && e.key === this._pttTeamKey && !e.repeat && (this._teamPttReleaseSound.stop(), this._teamPttClickSound.play()), this._pttKey && this._connectionState === y.VOICE_CONNECTED_STATE && this._pttActive && e.key === this._pttKey && !e.repeat && (this._partyPttReleaseSound.stop(), this._partyPttClickSound.play()))
                }
                _handleKeyUp(e) {
                    this._teamVoicePluginEnabled && (this._pttTeamKey && this._teamConnectionState === y.VOICE_CONNECTED_STATE && e.key === this._pttTeamKey && (this._teamPttClickSound.stop(), this._teamPttReleaseSound.play()), this._pttKey && this._connectionState === y.VOICE_CONNECTED_STATE && this._pttActive && e.key === this._pttKey && (this._partyPttClickSound.stop(), this._partyPttReleaseSound.play()))
                }
                _playJoinSound() {
