(() => {
    var e = [function(e, t, n) {
            ...
            class k extends i.default {
                ...
                participantsUpdated(e) {
                    const t = e && e.length > 0 ? y.VOICE_CONNECTED_STATE : y.VOICE_DISCONNECTED_STATE,
                        n = e ? e.length : 0;
                    this._connectionState === y.VOICE_DISCONNECTED_STATE && t === y.VOICE_CONNECTED_STATE ? (this._playJoinSound(), this._lockOutMemberJoinSound = !0, clearTimeout(this._memberJoinTimeout), this._memberJoinTimeout = setTimeout((() => {
                        this._lockOutMemberJoinSound = !1
                    }), 500)) : this._connectionState === y.VOICE_CONNECTED_STATE && t === y.VOICE_DISCONNECTED_STATE || this._connectionState === y.VOICE_CONNECTED_STATE && n < this._previousParticipantCount ? this._playLeaveSound() : this._connectionState === y.VOICE_CONNECTED_STATE && n > this._previousParticipantCount && !this._lockOutMemberJoinSound && this._playDelayedJoinSound();
                ...
                teamVoiceSessionUpdated(e) {
                    const t = e && e.participants && e.participants.length > 0,
                        n = t ? y.VOICE_CONNECTED_STATE : y.VOICE_DISCONNECTED_STATE;
                ...
                _handleKeyDown(e) {
                    this._teamVoicePluginEnabled && (!this._pttTeamKey || this._teamConnectionState !== y.VOICE_CONNECTED_STATE || this._teamVoiceRestricted || e.key !== this._pttTeamKey || e.repeat || (this._teamPttReleaseSound.stop(), this._teamPttClickSound.play()), this._pttKey && this._connectionState === y.VOICE_CONNECTED_STATE && this._pttActive && e.key === this._pttKey && !e.repeat && (this._partyPttReleaseSound.stop(), this._partyPttClickSound.play()))
                }
                _handleKeyUp(e) {
                    this._teamVoicePluginEnabled && (this._pttTeamKey && this._teamConnectionState === y.VOICE_CONNECTED_STATE && !this._teamVoiceRestricted && e.key === this._pttTeamKey && (this._teamPttClickSound.stop(), this._teamPttReleaseSound.play()), this._pttKey && this._connectionState === y.VOICE_CONNECTED_STATE && this._pttActive && e.key === this._pttKey && (this._partyPttClickSound.stop(), this._partyPttReleaseSound.play()))
                }
                _playJoinSound() {
