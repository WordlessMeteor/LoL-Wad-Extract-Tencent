    ...
    var e = [function(e, t, n) {
            ...
            class L extends r.default {
                ...
                _getTeamVoiceStatusLabelKey() {
                    return this._teamConnectionState === E.VOICE_CONNECTED_STATE ? this._teamVoiceRestricted ? N[P] : null : this._teamVoiceAvailabilityReason === M ? N[M] : this._teamVoiceAvailability ? this._teamVoiceConnectionFailed ? "parties_comm_panel_team_voice_status_try_again" : null : N[this._teamVoiceAvailabilityReason] || V
                }
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.default = t.buildMigrationPlan = t.buildKeybindRows = t.MIGRATION_VERSION_KEY = void 0;
            var r = function(e, t) {
                    if (!t && e && e.__esModule) return e;
                    if (null === e || "object" != typeof e && "function" != typeof e) return {
                        default: e
            ...
            const m = (e, t) => (0, o.normalizeKeybinding)((0, o.primaryKeybinding)(e)) === t.legacy,
                u = (e, t) => {
                ...
                g = (e, t) => {
                    ...
                    return "" === n || n === o.UNBOUND ? [] : d.flatMap((t => Object.entries(e && e[t] || {}).flatMap((([e, r]) => (0, o.splitKeybindings)(r).filter((e => (0, o.normalizeKeybinding)(e) === n)).map((() => `${t}.${e}`))))))
                },
                ...
                b = (e, t) => {
                    const n = {},
                        r = {},
                        i = A(e, o.CHARACTER_MENU),
                        a = A(e, o.ROLE_QUEST),
                        l = _(t, o.PARTY_PTT),
                        s = _(t, o.TEAM_PTT);
                    if (m(l, o.PARTY_PTT)) {
                        const t = g(e, o.PARTY_PTT.next),
                            a = m(i, o.CHARACTER_MENU),
                            s = 0 === g(e, o.CHARACTER_MENU.next).length;
                        !v(t, o.CHARACTER_MENU.path) || a && !s || (a && (n[o.CHARACTER_MENU.section] = n[o.CHARACTER_MENU.section] || {}, n[o.CHARACTER_MENU.section][o.CHARACTER_MENU.key] = u(i, o.CHARACTER_MENU.next)), r[o.PARTY_PTT.field] = u(l, o.PARTY_PTT.next))
                    }
                    if ((0, o.isUnbound)(s)) {
                        const t = g(e, o.TEAM_PTT.next),
                            i = m(a, o.ROLE_QUEST),
                            l = 0 === g(e, o.ROLE_QUEST.next).length;
                        !v(t, o.ROLE_QUEST.path) || i && !l || (i && (n[o.ROLE_QUEST.section] = n[o.ROLE_QUEST.section] || {}, n[o.ROLE_QUEST.section][o.ROLE_QUEST.key] = u(a, o.ROLE_QUEST.next)), r[o.TEAM_PTT.field] = u(s, o.TEAM_PTT.next))
                    }
                    return {
                        inputUpdates: n,
                        voiceUpdates: r
            ...
            t.buildMigrationPlan = b;
            const y = (e, t, n) => o.KEYBIND_DEFINITIONS.map((r => {
                const i = e => r.field ? e.voiceSettings && e.voiceSettings[r.field] || "" : A(e.inputSettings, r),
                    a = ((e, {
                        inputUpdates: t,
                        voiceUpdates: n
                    }) => e.field ? Boolean(n[e.field]) : Boolean(t[e.section] && t[e.section][e.key]))(r, n);
                return {
                    id: r.id,
                    moved: a,
                    from: a ? (0, o.primaryKeybinding)(i(e)) : null,
                    to: (0, o.primaryKeybinding)(i(t))
                }
            }));
            t.buildKeybindRows = y;
            var f = new class {
                constructor() {
                ...
                async _evaluate() {
                    ...
                    const i = b(n.inputSettings, n.voiceSettings);
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.splitKeybindings = t.primaryKeybinding = t.normalizeKeybinding = t.keybindTokens = t.isUnbound = t.UNBOUND = t.TEAM_PTT = t.ROLE_QUEST = t.PARTY_PTT = t.KEYBIND_DEFINITIONS = t.CHARACTER_MENU = void 0;
            const n = "[<unbound>]";
            t.UNBOUND = n;
            const r = {
                id: "party_ptt",
            ...
            t.normalizeKeybinding = l;
            const s = e => ("string" == typeof e ? e : "").split(",").filter(Boolean);
            t.splitKeybindings = s;
            const c = e => s(e)[0] || "";
            t.primaryKeybinding = c;
            const p = e => {
                const t = l(c(e));
                return "" === t || t === n
            };
            ...
            t.keybindTokens = e => {
                const t = c(e);
                return p(t) ? [] : (t.match(/\[[^[\]]*\]/g) || []).map((e => e.slice(1, -1))).map((e => /^[a-z]$/.test(e) ? e.toUpperCase() : e))
            };
            const d = [r, i, a, o];
            t.KEYBIND_DEFINITIONS = d
        }, (e, t) => {
            "use strict";
            Object.defineProperty(t, "__esModule", {
                value: !0
