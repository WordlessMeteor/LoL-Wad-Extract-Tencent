(() => {
    var e = [, e => {
            ...
            e.exports = s.Ember.Component.extend({
                ...
                challengerQueues: s.Ember.computed("challengerLaddersEnabled", "selectedLeague.queueType", "leagues", "overlayMode", (function() {
                    const e = this,
                    ...
                    const n = this.get("leagues.summonerLeagues"),
                        a = [];
                    return t.forEach((t => {
                        const o = n.find((e => e?.queueType === t && s.LeaguesConsts.APEX_TIERS.includes(e.tier)));
                ...
                topRatedLadderQueues: s.Ember.computed("topRatedLaddersEnabled", "selectedLeague.queueType", "leagues", "overlayMode", (function() {
                    const e = this,
                    ...
                    const n = this.get("leagues.summonerLeagues"),
                        a = [];
                    return t.forEach((t => {
                        const o = n.find((e => e?.queueType === t && s.LeaguesConsts.RATED_TIER_NAME_NONE !== e.tier));
                        if (this.get("overlayMode") && !o) return;
                        const l = {
                            queueType: t,
