    ...
    var e = [, e => {
            ...
            var d = a.Ember.Component.extend({
                ...
                showSeasonMemorialModal: a.Ember.computed("haveSeasonMemorialModalRewardsData", "isHonorEligible", "highestRankQueue.tier", (function() {
                    return this.get("haveSeasonMemorialModalRewardsData") && this.get("isHonorEligible") && !!this.get("highestRankQueue.tier") || !!this.get("highestRankQueue.tier") && !this.get("isHonorEligible")
                })),
