    ...
    var t = [, (t, n, e) => {
            ...
            var s = class {
                ...
                async init() {
                    ...
                    const a = await t.load(this._dependencyGraphUrl),
                        c = new i.default(n, a);
                    await c.start(), window.logEmberApplications && (console.info("[logEmberApplicationsCount] allPluginsLoaded: " + window.logEmberApplications.length), console.info("[logEmberApplications] allPluginsLoaded: " + window.logEmberApplications))
                }
                showWindow() {
                    window.riotInvoke({
            ...
            t = e.nmd(t),
                function() {
                    var i, u = "Expected a function",
                        ...
                        rn = RegExp([Ht + "?" + Ct + "+" + Vt + "(?=" + [Mt, Ht, "$"].join("|") + ")", Gt + "+" + Jt + "(?=" + [Mt, Ht + Bt, "$"].join("|") + ")", Ht + "?" + Bt + "+" + Vt, Ht + "+" + Jt, "\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])", "\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])", zt, Xt].join("|"), "g"),
                    ...
                    var ge = function t(n) {
                                    ...
                                    function(t, n, e, r, u, o, a) {
                                        ...
                                        if (h) {
                                            var p = qo(s),
                                                d = !p && Jo(s),
                                                v = !p && !d && sa(s);
                                            l = s, p || d || v ? qo(c) ? l = c : Vo(c) ? l = Ti(c) : d ? (h = !1, l = ki(s, !0)) : v ? (h = !1, l = Si(s, !0)) : l = [] : ia(s) || Ho(s) ? (l = c, Ho(c) ? l = ga(c) : (!ta(c) || r && Qo(c)) && (l = gu(s))) : h = !1
                                        }
                        ...
                        function $i(t, n, e, u, o, a, c, s, f, h) {
                            ...
                            return function l() {
                                ...
                                if (u && (w = Pi(w, u, o, _)), a && (w = Oi(w, a, c, _)), m -= E, _ && m < h) {
                                    var k = fe(w, x);
                                    return Ji(t, n, $i, l.placeholder, e, w, k, s, f, h - m)
                                }
                                var A = d ? e : this,
                                    S = v ? A[t] : t;
                        ...
                        function Ji(t, n, e, r, u, o, a, c, l, h) {
                            var p = 8 & n;
                        ...
                        function Xi(t, n, e, o, p, d, v, _) {
                            ...
                            if (b && function(t, n) {
                                ...
                                return function o() {
                                    ...
                                    return (a -= l.length) < e ? Ji(t, n, $i, o.placeholder, i, c, l, i, i, e - a) : Pn(this && this !== _n && this instanceof o ? u : t, this, c)
                                }
                        ...
                        function gu(t) {
                            return "function" != typeof t.constructor || ku(t) ? {} : Ue(Jt(t))
                        }
                        ...
                        var Nu = Qr((function(t, n) {
                                return Vo(t) ? hr(t, yr(n, 1, Vo, !0)) : []
                            })),
                            Fu = Qr((function(t, n) {
                                var e = Zu(n);
                                return Vo(e) && (e = i), Vo(t) ? hr(t, yr(n, 1, Vo, !0), su(e, 2)) : []
                            })),
                            $u = Qr((function(t, n) {
                                var e = Zu(n);
                                return Vo(e) && (e = i), Vo(t) ? hr(t, yr(n, 1, Vo, !0), i, e) : []
                            }));
                        ...
                        var to = Qr((function(t) {
                                return li(yr(t, 1, Vo, !0))
                            })),
                            no = Qr((function(t) {
                                var n = Zu(t);
                                return Vo(n) && (n = i), li(yr(t, 1, Vo, !0), su(n, 2))
                            })),
                            eo = Qr((function(t) {
                                var n = Zu(t);
                                return n = "function" == typeof n ? n : i, li(yr(t, 1, Vo, !0), i, n)
                            }));
                        ...
                        function ro(t) {
                            ...
                            return t = Mn(t, (function(t) {
                                if (Vo(t)) return n = me(t.length, n), !0
                            })), Xn(n, (function(n) {
                                return Dn(t, Jn(n))
                            }))
                        }
                        ...
                        var uo = Qr((function(t, n) {
                            ...
                            ao = Qr((function(t) {
                                var n = Zu(t);
                                return Vo(n) && (n = i), _i(Mn(t, Vo), su(n, 2))
                            })),
                            co = Qr((function(t) {
                                var n = Zu(t);
                                return n = "function" == typeof n ? n : i, _i(Mn(t, Vo), i, n)
                            })),
                            so = Qr(ro);
                        ...
                        function Io(t, n) {
                            ...
                            return e.cache = new(Io.Cache || Je), e
                        }
                        ...
                        function hc(t) {
                            return bu(t) ? Jn(Du(t)) : function(t) {
                                return function(n) {
                                    return kr(n, t)
                                }
                            }(t)
                        ...
                        return $e.after = function(t, n) {
                        ...
                        }, $e.intersection = Gu, $e.intersectionBy = Vu, $e.intersectionWith = Ju, $e.invert = Pa, $e.invertBy = Oa, $e.invokeMap = bo, $e.iteratee = ic, $e.keyBy = xo, $e.keys = Ra, $e.keysIn = La, $e.map = Eo, $e.mapKeys = function(t, n) {
                            var e = {};
                            ...
                            return t && t.length && n && n.length ? Vr(t, n, su(e, 2)) : t
                        }, $e.pullAllWith = function(t, n, e) {
                            return t && t.length && n && n.length ? Vr(t, n, i, e) : t
                        ...
                        }, $e.invoke = Ta, $e.isArguments = Ho, $e.isArray = qo, $e.isArrayBuffer = Bo, $e.isArrayLike = Go, $e.isArrayLikeObject = Vo, $e.isBoolean = function(t) {
                            return !0 === t || !1 === t || na(t) && Sr(t) == w
                        }, $e.isBuffer = Jo, $e.isDate = Zo, $e.isElement = function(t) {
                            return na(t) && 1 === t.nodeType && !ia(t)
                        }, $e.isEmpty = function(t) {
                            if (null == t) return !0;
                            if (Go(t) && (qo(t) || "string" == typeof t || "function" == typeof t.splice || Jo(t) || sa(t) || Ho(t))) return !t.length;
                            var n = vu(t);
                        ...
                        }, $e.snakeCase = Va, $e.some = function(t, n, e) {
                            var r = qo(t) ? Fn : ui;
                            return e && wu(t, n, e) && (n = i), r(t, su(n, 3))
                            ...
                            return -1
                        }, $e.startCase = Ja, $e.startsWith = function(t, n, e) {
                            ...
                            var v = n.variable;
                            v || (h = "with (obj) {\n" + h + "\n}\n"), h = (o ? h.replace(B, "") : h).replace(G, "$1").replace(V, "$1;"), h = "function(" + (v || "obj") + ") {\n" + (v ? "" : "obj || (obj = {});\n") + "var __t, __p = ''" + (u ? ", __e = _.escape" : "") + (o ? ", __j = Array.prototype.join;\nfunction print() { __p += __j.call(arguments, '') }\n" : ";\n") + h + "return __p\n}";
                            var _ = Xa((function() {
                            ...
                            return (t = ya(t)) && K.test(t) ? t.replace(J, _e) : t
            ...
            class a extends r {
                constructor(t, n) {
                    i?.("creating CoreSocket", t), super(), this._websocket = null, this._endpoint = t, this._connected = !1, this._sendQueue = [], this._options = n, this._resolvers = {}, f(this)
                }
                call(t, n, e) {
                    const r = "xxxxxxxxxxxxxxxx".replace(/x/g, (() => (36 * Math.random() | 0).toString(36)));
                    return new Promise(((o, a) => {
                        this._resolvers[r] = [s(this, r, o), s(this, r, a)], i?.("sending CALL message", r, t, n, e), c(this, [u.CALL, r, t, n, e])
                    }))
                }
                close() {
            ...
            function f(t) {
                const n = t._websocket = new a.WebSocket(t._endpoint, ["wamp"], t._options);
                n.onopen = h.bind(null, t), n.onclose = p.bind(null, t), n.onerror = l.bind(null, t), n.onmessage = d.bind(null, t)
            }
            ...
            function p(t, n) {
                ...
                i?.(e), t.closed();
                1006 === n.code ? (f(t), console.log(e)) : console.error(e)
            }

            function d(t, n) {
                i?.("WebSocket event: MESSAGE", n.data.length, "bytes");
                const e = parseInt(n.data[1]);
                if (e === u.EVENT) ! function(t, n) {
                    const e = JSON.parse(n.data),
                        [, , r] = e,
                        u = r && r.uri ? r.uri : "";
                    i?.("received EVENT", o, e), u ? t.publish(u, e) : i?.("received EVENT with no uri", e)
                }(t, n);
                else {
                    const r = JSON.parse(n.data);
                    if (e === u.WELCOME)[t._wampSessionId, t._wampProtocolVersion, t._wampServerIdentity] = r.slice(1), t.ready(), c(t), c(t, [u.SUBSCRIBE, o]);
            ...
            a.WebSocket = window.WebSocket, t.exports = a
        }, (t, n, e) => {
            "use strict";
